...
const formSchema = z.object({
  ...
  shortDescription: z
    .string()
    .min(1, { message: "short description of product is required" })
    .max(60),
  description: z
    .string()
    .min(1, { message: "description of product is required" })
    .max(1000),
  price: z.string().min(1, { message: "price of product is required" }),
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Entere product name.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Entere product short description.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
